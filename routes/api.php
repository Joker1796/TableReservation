...
Route::group(['middleware' => 'auth:sanctum'], function () {
    ...
    Route::delete(
        '/reservation/{reservation}',
        [ReservationController::class, 'softDelete']
    );
    Route::put(
        '/reservation/{reservation}/user/{user}',
        [ReservationController::class, 'attachUser']
    );
    Route::delete(
        '/reservation/{reservation}/user/{user}',
        [ReservationController::class, 'detachUser']
    );
    ...
    Route::get(
        ...
        [ReservationRequestController::class, 'show']
    );
    Route::put(
        '/reservation-request/{reservationRequest}',
        [ReservationRequestController::class, 'update']
    );
    Route::delete(
        '/reservation-request/{reservationRequest}',
        [ReservationRequestController::class, 'softDelete']
    );
    Route::put(
    ...
    Route::delete(
        '/table/{table}',
        [TableController::class, 'softDelete']
    );
    Route::put(
        '/table/{table}/reservation/{reservation}',
        [TableController::class, 'addReservation']
    );
    Route::delete(
        '/table/{table}/reservation/{reservation}',
        [TableController::class, 'deleteReservation']
    );
    Route::put(
        '/table/{table}/reservation-request/{reservationRequest}',
        [TableController::class, 'addReservationRequest']
    );
    Route::delete(
        '/table/{table}/reservation-request/{reservationRequest}',
        [TableController::class, 'deleteReservationRequest']
    );

    Route::put(
        '/user/{user}/reservation/{reservation}',
        [UserController::class, 'attachReservation']
    );
    Route::delete(
        '/user/{user}/reservation/{reservation}',
        [UserController::class, 'detachReservation']
    );
    Route::put(
        '/user/{user}/reservation-request/{reservationRequest}',
        [UserController::class, 'attachReservationRequest']
    );
    Route::delete(
        '/user/{user}/reservation-request/{reservationRequest}',
