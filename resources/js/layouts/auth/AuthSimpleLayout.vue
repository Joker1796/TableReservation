        ...
        <div class="flex items-center justify-center px-6 py-12">
            <div class="w-full max-w-sm">
                <div class="mb-8 text-center">
                    ...
                    <p class="mt-2 text-sm text-[#706f6c] dark:text-[#A1A09A]">{{ description }}</p>
                </div>
                <div class="rounded-xl border border-[#e3e3e0] bg-white p-8 shadow-sm dark:border-[#3E3E3A] dark:bg-[#161615]">
                    <slot />
                </div>
            </div>
        </div>
