...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            ...
            description:
                'Двухфакторная аутентификация включена. Отсканируйте QR-код или введите ключ настройки в приложении аутентификатора.',
            buttonText: 'Закрыть',
        };
    }
    ...
    if (showVerificationStep.value) {
        return {
            title: 'Подтвердите код аутентификации',
    ...
    return {
        ...
        description: 'Для завершения настройки отсканируйте QR-код или введите ключ в приложении аутентификатора',
        buttonText: 'Продолжить',
    };
});
                ...
                <template v-if="!showVerificationStep">
                    ...
                    <template v-else>
                        ...
                        <div class="relative flex w-full items-center justify-center">
                            ...
                            <span class="relative bg-card px-2 py-1">или введите код вручную</span>
                        </div>
